...
echo
	...
	B.O.SVersion='rolling'

	isoLabel='B.O.S'$B.O.SVersion'-x86_64.iso'

	# setting of the general parameters
	archisoRequiredVersion="archiso 72-1"
	buildFolder=$HOME"/B.O.S-build"
	outFolder=$HOME"/B.O.S-Out"
        # outFolder="/mnt/hgfs/VirtualShare/B.O.S-Out"
	...
	echo "Building version                       : "$B.O.SVersion
...
echo
	...
	echo "Getting the last version of bashrc in /etc/skel"
	echo
	wget https://raw.githubusercontent.com/obulesh003/b.o.s-Linux/main/releng/airootfs/etc/etc/skel/.bashrc -O $buildFolder/archiso/airootfs/etc/skel/.bashrc
...
echo
	...
	#profiledef.sh
	oldname1='iso_name="B.O.S"'
	newname1='iso_name="B.O.S"'

	oldname2='iso_label="B.O.S"'
	newname2='iso_label="B.O.S"'
